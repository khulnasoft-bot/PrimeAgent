  ...
  describe("Basic widget code generation", () => {
    it("should generate widget code with API key when isAuth is false", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/primeagent-embedded-chat",
      );
    ...
    it("should generate widget code without API key when isAuth is true", () => {
      ...
      expect(code).toContain("<script");
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/primeagent-embedded-chat@v1.0.7",
      );
    ...
    it("should use formatted CDN URL when copy is true", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/primeagent-embedded-chat@v1.0.7/dist/build/static/js/bundle.min.js",
      );
