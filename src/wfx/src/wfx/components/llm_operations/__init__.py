...
if TYPE_CHECKING:
    ...
    from wfx.components.llm_operations.lambda_filter import SmartTransformComponent
    from wfx.components.llm_operations.llm_conditional_router import SmartRouterComponent
    from wfx.components.llm_operations.llm_selector import LLMSelectorComponent
