...
if TYPE_CHECKING:
    ...
    from wfx.components.input_output.text import TextInputComponent
    from wfx.components.input_output.text_output import TextOutputComponent
    from wfx.components.input_output.webhook import WebhookComponent
