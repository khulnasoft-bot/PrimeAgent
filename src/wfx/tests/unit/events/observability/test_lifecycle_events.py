...
class MockEventManager:
    """Mock for wfx.events.event_manager.EventManager."""
...
class MockLogger:
    """Mock for wfx.log.logger.logger."""
...
def mock_dependencies():
    ...
    with (
        patch("wfx.events.observability.lifecycle_events.logger", mock_logger_instance),
        patch("wfx.events.observability.lifecycle_events.encoder", mock_encoder_instance),
    ):
        yield {
